...
description: "Use when the user wants an end-to-end natural-language AI infinite canvas workflow: opening AI Canvas, including the startup phrase 打开AI画布, generating images into holders, reading canvas annotations, handling phrases like 要求后续变更 / 按标注修改, and creating edited image versions."
---
...
## If The User Only Says "打开 AI 画布" Or "打开AI画布"
