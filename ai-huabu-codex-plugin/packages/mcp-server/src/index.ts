...
server.registerTool(
  'prepare_image_generation',
  {
    ...
    description:
      'Conversation-first workflow entry: open AI Huabu, find or create a holder, and return the prompt/output target for image generation.',
    ...
    if (!holder) {
      ...
      try {
        ...
        const result: PreparedImageGeneration = {
          ...
          message:
            'AI Huabu 已启动，但图片框还没有创建成功。请保留生成结果文件，并把返回的画布 URL 提供给用户打开查看。',
          url: opened.url,
...
server.registerTool(
  'import_image_asset',
  {
    ...
    description:
      'Import a local image file into AI Huabu as a selectable image that can be used by canvas Skills.',
...
server.registerTool(
  'import_image_from_url',
  {
    ...
    description:
      'Download a supported image URL and import it into AI Huabu as a selectable image.',
...
server.registerTool(
  'watch_edit_requests',
  {
    ...
    description:
      'Wait for an edit request submitted from the AI Huabu button. Use for auto edit mode.',
  ...
  async (input) => {
    ...
    return asToolResult({
      ...
      timedOut: true,
      message:
        'No queued AI Huabu edit request yet. The image is ready; Codex is waiting for the user to annotate the canvas and click 按标注修图.'
...
server.registerTool(
  'watch_skill_requests',
  {
    ...
    description:
      'Wait for a queued AI Huabu Skill request submitted from the canvas Skill panel and process its generationJobs sequentially.',
  ...
  async (input) => {
    ...
    return asToolResult({
      ...
      timedOut: true,
      message:
        'No queued AI Huabu Skill request yet. Codex is waiting for the user to select an image, choose a Skill, and submit it from the canvas Skill panel.'
...
server.registerTool(
  'run_canvas_skill',
  {
    ...
    description:
      'Run a prepared AI Huabu Skill and return external generation jobs plus placement plans for Codex to process.',
